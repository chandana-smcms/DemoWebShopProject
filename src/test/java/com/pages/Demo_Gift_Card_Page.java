...
public class Demo_Gift_Card_Page {
	...
	By virtualgiftcard = By.xpath("//h2[@class='product-title']//a[contains(text(),'$5 Virtual Gift Card')]");
	By name = By.xpath("//input[@id='giftcard_1_RecipientName']");
	By emailid = By.xpath("//input[@id='giftcard_1_RecipientEmail']");
	By message = By.xpath("//textarea[@id='giftcard_1_Message']");
	By addtocart1 = By.xpath("//input[@id='add-to-cart-button-1']");
	...
	public void addToCart() throws IOException, InterruptedException {
		...
		//Thread.sleep(5000);// waits for the function to complete
